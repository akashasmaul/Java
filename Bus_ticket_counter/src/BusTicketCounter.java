/*project name: Bus ticket Counter
group members name:
1. md.ishtiaq kadir(1531166042)
2. Name - Dipta Kumar Nath (1612720642)
3. Name – Sumaya yeacin Rimu (1530664042)
*/
...
public class  BusTicketCounter implements ActionListener {
	...
	public BusTicketCounter(){
		frame = new JFrame();
		try {
			frame.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("C:/Users/ASUS/workspace/Bus_ticket_counter/bus.jpg")))));
		} catch (IOException e) {
